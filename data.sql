...
SELECT books.id, books.title, books.img, categories.name AS category, books.isbn, books.summary, books.detail, books.author, books.pages, books.contents, books.price, books.pub_date
FROM books
